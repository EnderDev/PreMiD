...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var dist, src, srcPackageJSON, packageJSON;
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, Promise.all(dist
                        ...
                        f.replace("dist/app/", "").replace(path_1.basename(f), path_1.basename(f, ".js")),
                        f
                    ]; })
                        .filter(function (d) {
                        return !src
                            .map(function (f) {
                            return f.replace("src/", "").replace(path_1.basename(f), path_1.basename(f, ".ts"));
                        })
                            .includes(d[0]);
                    })
                        .map(function (f) { return fs_extra_1.removeSync(f[1]); }))];
            case 3:
                //* Delete js files in dist that are no longer existant in src folder
                _a.sent();
                srcPackageJSON = require("./src/package.json"), packageJSON = require("./package.json");
